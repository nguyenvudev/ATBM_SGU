...
//                            let decryptedBody = data.decrypted_body; // Chuyển đổi các ký tự xuống dòng thành thẻ <br>
//                            decryptedBody = decryptedBody.replace(/\n/g, '<br>');
//                            document.getElementById('decryptedBodySeen').innerHTML = decryptedBody;
//
//                            document.getElementById('bodySeenContent').style.display = 'block';
//                            document.getElementById('noDecryptedBodySeen').style.display = 'none';
//                        } else {
//                            document.getElementById('bodySeenContent').style.display = 'none';
//                            document.getElementById('noDecryptedBodySeen').style.display = 'block';
//                        }
//
//
//                        if (data.decrypted_attachments && data.decrypted_attachments.length > 0) {
